#+Seq_TODO: TODO DOING | WONTDO DONE
* Done User Stories
** DONE Bug: Build.pl
...
**** find_callers
***** --method=x
****** Return data structure with call sites for unique calls to ->x in Perl files (.pm, .pl) in the current project
******* package
******* sub_name
****** Possibly
******* file
...
** \C-o r c for Run with Cover
*** DONE Use the regular Run command, but
**** DONE Check covered is installed
**** DONE cover -delete;
**** DONE Set $ENV{PERL5OPT} .= "-MDevel::Cover" during the test run (alone)
**** DONE covered runs
**** DONE Loop over all buffers and re-load the coverage data
**** DONE If coverage not visible, enable visible
***** Especially for the compiled buffer
**** DONE Changes
**** DONE Docs
***** Only Unix
...
****** /covered/*
*** Alternate
**** Mention in Changes, that it just works on Unix systems
