...
** TODO Run History - Goto, Run

Just keep a *PerlySense-Compilation-History* buffer around and add a
line at the top for each new file.

Then with C-o C-r on a line would run that file.
...
** DOING Smart Goto variable declaration
